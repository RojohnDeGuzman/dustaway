          ...
          <div className="flex-1">
            <div className="mb-4 text-center">
              ...
              <p className="text-sm text-[var(--text-body)] mt-1 mb-4 font-medium text-center">
                Give your home a renewal with an extra set of hands! Our 3 or
                4-hour spring cleaning service includes an addition professional
                crew member, covering more within the same time for a
                comprehensive clean, leaving your home sparkling from top to
                bottom. <br />
                With a crew of 2 professionals, this enhanced cleaning goes
                beyond the basics, reaching those hard-to-reach areas and
                tackling dust bunnies and cobwebs for a thorough spring refresh.
              </p>
            </div>
            <div className="flex justify-center mb-6">
              <div className="inline-flex bg-pastel-green-lighter rounded-xl p-1 mb-6 border border-pastel-green-200/50">
            ...
            {activeTab === "4hr" && (
              <div className="mb-6 flex justify-center">
                <div className="bg-white/90 border border-pastel-green-200/50 rounded-xl p-6 max-w-xl w-full shadow-sm">
              ...
              <div className="bg-white/90 border border-pastel-green-200/50 rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-6 pt-0">
                  <ul className="list-disc pl-5 text-sm space-y-2 mb-4">
                    <li>
                      Please be reminded that cleaning supplies & equipment are
                      to be provided by you
                    </li>
                    <li>
                      Additional services as listed below are <b>NOT</b>{" "}
                      included
                    </li>
                  </ul>
