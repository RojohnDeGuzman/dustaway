          ...
          <div className="flex-1">
            <div className="mb-4 text-center ">
              ...
              <p className="text-sm text-[var(--text-body)] mt-1 mb-4 font-medium text-center">
                Ditch the cleaning after work! This 3-hour evening service lets
                you come home to a spotless haven, perfect for unwinding and
                recharging.
                <br />
                Don&apos;t let housework eat into your precious free time. Our
                evening cleaning service, available from 7pm to 10pm, is
                designed for busy working professionals and working parents.
                Relax and let us take care of the cleaning after a long day, and
        ...
        <div className="w-full bg-gradient-to-r from-pastel-pink-lighter via-white to-pastel-green-lighter py-10 rounded-[1.75rem] soft-divider">
          <div className="flex flex-col md:flex-row items-stretch gap-10 px-4 lg:px-8">
            ...
            <div className="flex-1 flex justify-center items-start">
              <div className="bg-white/95 rounded-xl shadow-sm overflow-hidden w-full max-w-lg border border-pastel-green-200/40">
