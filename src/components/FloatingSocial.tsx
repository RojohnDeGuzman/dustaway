...
const SOCIALS = [
  ...
  {
    name: 'Messenger',
    href: 'https://m.me/dustaway',
    icon: (
      <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M12 2C6.36 2 2 6.13 2 11.37c0 3.92 2.24 7.35 5.56 9.28V22l5.09-2.79a9.86 9.86 0 004.35.98c5.64 0 10-4.13 10-9.37S17.64 2 12 2zm5.44 7.05l-2.57 2.72-5.15-2.72L17.44 4l2.57 2.72 5.15 2.73-5.16 2.58z" />
      </svg>
    ),
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/dustaway',
    icon: (
      <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              >
                {SOCIALS.map((social, i) => (
                  ...
                  >
                    ...
                    <span className="font-medium text-sm whitespace-nowrap">{social.name}</span>
                  </motion.a>
                ))}
              </motion.div>
            )}
